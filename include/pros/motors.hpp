...
class Motor {
	...
	Motor(const std::int8_t port, const pros::v5::MotorGears gearset = pros::v5::MotorGears::green, const pros::v5::MotorUnits encoder_units = pros::v5::MotorUnits::degrees)
